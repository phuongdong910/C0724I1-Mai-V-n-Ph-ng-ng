...
public class MenuUI {
        ...
        do {
            ...
            switch (choice) {
                case 1:
                    ...
                    break;
                case 2:
                    ProductManagement.searchProductByName(input, shirts, pants, shoes, sportsEquipments);
                    break;
                case 3:
    ...
    private void adminMenu() {
        ...
        do {
            ...
            System.out.println("6. View All Customers' Purchase History");
            System.out.println("0. Exit");
            choice = getIntInput();
            switch (choice) {
                case 1:
    ...
    private void addNewProductMenu() {
        ...
        switch (choice) {
            ...
            case 2:
                ...
                break;
            case 3:
                SportsEquipmentService.ShoesService.addShoes(shoes, input);
                break;
            case 4:
                SportsEquipmentService.addSportsEquipment(sportsEquipments, input);
                break;
            case 0:
                return;
            default:
